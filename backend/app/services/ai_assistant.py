...
async def generate_caption(prompt: str, platform: str = "instagram", tone: str = "professional") -> str:
    """
    Generate a social media caption using Azure OpenAI.
    """
    try:
...
- Platform: {platform}
- Tone: {tone}
- Include relevant hashtags at the end for Instagram
- Keep it concise but engaging
- Add appropriate emojis
- For LinkedIn: more professional, no excessive hashtags
- For Twitter/X: respect character limits
"""
...
async def repurpose_caption(original_caption: str, target_platform: str) -> str:
    """
    Repurpose a caption for a different platform.
    """
    try:
        client = get_azure_client()
        deployment = os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME", "MMNext-gpt-4o")
        ...
        logger.error(f"Caption repurpose error: {e}")
        raise e
